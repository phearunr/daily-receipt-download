    ...
    <table border="1" cellspacing="15px">
        ...
        <tbody>
                ...
                @if(isset($order['products'][$i]))
                    <tr>
                        ...
                        <td align="left" colspan="6">
                            {{ $order['products'][$i]['product_name'] }}
                        </td>
                        <td align="center">{{ $order['products'][$i]['order_quantity'] }}</td>
                        <td align="center">{{ $order['products'][$i]['product_price'] }}</td>
            ...
            <tr>
                ...
                <td>សរុបរួម (KHR)</td>
                {{-- <td>{{ $order['total_quantity'] }}</td> --}}
                <td align="center">{{ $order['grand_total_price_riel'] }}</td>
            </tr>
